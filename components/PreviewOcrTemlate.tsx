...
const PreviewOcrTemplate = ({ onClose, setCurrentStep }: PreviewChangesProps) => {
    ...
    const { moduleExtended, ocrCode, name, description, ocrApi, module, store, channel, limit } = formData;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative z-10 flex bg-[#FAFAFA] shadow-md rounded p-4">
            {loadingSubmit && (
            ...
            <div className="flex flex-col gap-4">
                    ...
                    <input
                        ...
                        value={
                            moduleExtended.length > 0
                                ? moduleExtended.map(m => m.name).join(', ')
                                : '-'
                        }
                        className="bg-gray-200 p-2 rounded w-64"
                    />
                ...
                <div className="flex justify-center gap-4">                
                    ...
                    <button 
                        className="bg-blue-300 w-30 h-8 rounded button"
