    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative z-10 flex bg-[#FAFAFA] shadow-md rounded p-4 max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                        ...
                        <textarea
                            readOnly
                            value={description || '-'}
                            className="bg-gray-200 p-2 rounded w-64 h-32"
                        />
                    ...
                    <div className="flex justify-center gap-4 mt-2">
                        <button
                            className="bg-gray-200 w-30 h-8 rounded hover:bg-gray-300"
                            onClick={onClose}
                        >
                            Cancel
                        </button>
                        <button
                            className="bg-blue-300 w-30 h-8 rounded button font-bold text-white"
                ...
                <div
                    className={`bg-[#FAFAFA] transition-all duration-300 overflow-hidden ${showScripts ? 'w-120 border-l border-gray-300 pl-4 ml-4' : 'w-0 border-none'}`}
                >
